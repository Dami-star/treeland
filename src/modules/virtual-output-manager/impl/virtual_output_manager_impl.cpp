...
static treeland_virtual_output_manager_v1 *treeland_virtual_output_manager_from_resource(wl_resource *resource);
static void treeland_virtual_output_manager_bind(wl_client *client, void *data, uint32_t version, uint32_t id);

static void treeland_virtual_output_manager_handle_create_virtual_output([[maybe_unused]]struct wl_client *client,
                                                                         struct wl_resource *manager_resource,
                                                                         uint32_t id,
                                                                         const char *name,
                                                                         struct wl_array *outputs);

static void treeland_virtual_output_manager_handle_get_virtual_output_list([[maybe_unused]]struct wl_client *client, struct wl_resource *resource);

static void treeland_virtual_output_manager_handle_get_virtual_output([[maybe_unused]]struct wl_client *client,
                                                                      struct wl_resource *resource,
                                                                      const char *name,
                                                                      uint32_t id);

static void treeland_virtual_output_handle_destroy([[maybe_unused]]struct wl_client *client,
                                                   struct wl_resource *resource);
...
static const struct treeland_virtual_output_v1_interface virtual_output_impl {
    .destroy = treeland_virtual_output_handle_destroy,
};


static const struct treeland_virtual_output_manager_v1_interface virtual_output_manager_impl {
    .create_virtual_output = treeland_virtual_output_manager_handle_create_virtual_output,
    .get_virtual_output_list = treeland_virtual_output_manager_handle_get_virtual_output_list,
    .get_virtual_output = treeland_virtual_output_manager_handle_get_virtual_output,
};

static void treeland_virtual_output_resource_destroy(struct wl_resource *resource)
{
    wl_list_remove(wl_resource_get_link(resource));
}

static void treeland_virtual_output_manager_resource_destroy(struct wl_resource *resource)
{
    wl_list_remove(wl_resource_get_link(resource));
}
...
static void treeland_virtual_output_manager_handle_create_virtual_output([[maybe_unused]]struct wl_client *client,
                                                                         ...
                                                                         struct wl_array *outputs)
{
    auto *manager = treeland_virtual_output_manager_from_resource(manager_resource);
    ...
    wl_resource_set_implementation(resource,
                                   &virtual_output_impl,
                                   virtual_output,
                                   treeland_virtual_output_resource_destroy);
...
static void treeland_virtual_output_manager_handle_get_virtual_output_list([[maybe_unused]]struct wl_client *client, struct wl_resource *resource)
{
    auto *manager = treeland_virtual_output_manager_from_resource(resource);
...
{
    treeland_virtual_output_v1_send_outputs(resource, name.toUtf8().data(), outputs);
}
...
static void treeland_virtual_output_manager_bind(wl_client *client, void *data, uint32_t version, uint32_t id)
{
    ...
    wl_resource_set_implementation(resource,
                                   &virtual_output_manager_impl,
                                   manager,
                                   treeland_virtual_output_manager_resource_destroy);
...
treeland_virtual_output_manager_v1 *treeland_virtual_output_manager_v1::create(QWDisplay *display)
{
    ...
    manager->global = wl_global_create(display->handle(),
                                       ...
                                       manager,
                                       treeland_virtual_output_manager_bind);
    if (!manager->global) {
        delete manager;
        return nullptr;
    }
