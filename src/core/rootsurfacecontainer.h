...
#include "surface/seatsurfacecontainer.h"
...
public:
    ...
    SeatSurfaceContainer *getSeatContainer(WSeat *seat) const;
    WSeat *getDefaultSeat() const;
    SeatSurfaceContainer *getSeatContainerOrDefault(WSeat *seat = nullptr) const;
    ...
    //       object (or SeatSurfaceContainer), since move/resize state is inherently per-seat.
...
private:
    ...
    QMap<WSeat*, SeatSurfaceContainer*> m_seatContainers;
};
